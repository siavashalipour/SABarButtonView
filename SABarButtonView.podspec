#
# Be sure to run `pod lib lint SABarButtonView.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  ...
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/SABarButtonView.git", :tag => s.version.to_s }
